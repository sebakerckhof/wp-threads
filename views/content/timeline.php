...
<div class="threads-timeline">
    ...
    foreach ($posts as $_post) {
        ...
        ?>
        <div class="threads-item" style="margin-top: <?php echo $_post->threads_data['margin']; ?>px">
            <span class="date"><?php echo date('M j, Y', strtotime($_post->post_date)); ?></span><a class="title" href="<?php echo get_permalink($_post->ID); ?>" title="<?= esc_attr(get_the_title($_post->ID)); ?>"><?php echo get_the_title($_post->ID); ?></a>
            <?php
